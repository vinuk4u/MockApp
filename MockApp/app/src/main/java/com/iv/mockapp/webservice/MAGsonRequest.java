package com.iv.mockapp.webservice;
...
public class MAGsonRequest<T> extends Request<T> {
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            Type listType = new TypeToken<List<MAResponseModel>>() {
            }.getType();
            final MAResponseArrayModel arrayModel = new MAResponseArrayModel();
            arrayModel.setResponseModels((ArrayList<MAResponseModel>) mGson.fromJson(json, listType));
